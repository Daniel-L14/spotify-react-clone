...
const Discografia = () => {
  ...
  const artistas = [
    { nombre: "Lalo Ayala", imagen: "https://is1-ssl.mzstatic.com/image/thumb/Music221/v4/0d/b4/d8/0db4d8a6-c6c4-63d9-7d16-8c02173b7e79/199891526291_cover.jpg/1200x630bb.jpg" },
    { nombre: "Rojo Tabaco", imagen: "https://i.scdn.co/image/ab6761610000e5eb5a5b18fcf22acd0ec726389c" },
    { nombre: "Grupo Enigma", imagen: "https://i.scdn.co/image/ab67616d0000b27349870020d586470e0b5835ee" },
    { nombre: "Impulso", imagen: "https://i.scdn.co/image/ab67616100005174d67714368e965891c5122812" },
    { nombre: "Perseguidos", imagen: "https://i.scdn.co/image/ab67616d00001e0202933843035b9b16ce3fa747" },
  ];
  ...
  return (
    <>
      ...
      <section className="discografia">
        ...
        {activeTab === "populares" && (
          <div className="portadas-resumidas scroll-horizontal">
        ...
        <div className="portadas-resumidas scroll-horizontal">
          <div className="card-disco">
            <div className="imagen-container">
              ...
              <div className="overlay"><span className="play-icon"></span></div>
            </div>
            <h3>RGV JaMMz</h3>
            <p>De Mario Santos</p>
          </div>
      ...
      <section className="artistas">
        ...
        <div className="portadas-resumidas scroll-horizontal">
          {artistas.map((artista, index) => (
            <div key={index} className="card-disco">
              <div className="imagen-container imagen-redonda">
                <img src={artista.imagen} alt={artista.nombre} className="imagen-artista" />
                <div className="overlay">
                  <span className="play-icon"></span>
                </div>
              </div>
