...
const Player = () => {
  ...
  // Imagen del artista — cámbiala por la que necesites
  const COVER_URL = "https://i.scdn.co/image/ab6761610000e5eb5a5b18fcf22acd0ec726389c";
  ...
  return (
    <div className={`sp-player ${isCollapsed ? 'sp-collapsed' : ''}`}>

      {/* Línea de progreso visible en mini */}
      <div className="sp-top-progress">
        <div className="sp-top-fill" style={{ width: `${progress}%` }} />
      </div>

      {/* ── MODO MINI (colapsado) ── */}
      {isCollapsed && (
        <div className="sp-mini">
          <img className="sp-mini-cover" src={COVER_URL} alt="cover" />
          <div className="sp-mini-meta">
            <span className="sp-mini-name">Canción Actual</span>
            <span className="sp-mini-artist">Artista</span>
          </div>
          ...
          <button className="sp-collapse-btn" onClick={() => setIsCollapsed(false)} title="Expandir">
      ...
      {!isCollapsed && (
        <div className="sp-full">
          ...
          <div className="sp-right">
            ...
            {/* Botón colapsar */}
            <button className="sp-collapse-btn" onClick={() => setIsCollapsed(true)} title="Minimizar">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
